...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'sspace'))
...
project = u'Sample Space'
_full_version = sspace.__version__
author = sspace.__author__
copyright = sspace.__copyright__
...
latex_documents = [
    (master_doc, 'sspace.tex', u'Sample Space Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'sspace', 'Sample Space Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Sample Space', 'Sample Space Documentation',
     author, 'sample-space', sspace.__descr__,
     'Miscellaneous'),
]
